...
import TradingViewWidget from "../TradeOne";
  ...
  return (
    <div className="w-full h-[calc(100vh-5rem)] p-6 overflow-y-scroll scrollbar-thin scrollbar-hide ">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-100 uppercase">
          {user.fullName}
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        {[
          ...
          <div
            key={index}
            className="bg-[#0F3040] text-white p-4 rounded-lg flex flex-col gap-2"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <button
            className="w-full mt-4 py-2 bg-[#0F3040] text-white rounded-md"
