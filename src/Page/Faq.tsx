      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16">
          <motion.h2
            ...
            className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-[#c9c92c] via-[#dddd35] to-[#cece33] bg-clip-text text-transparent"
          >
            ...
            >
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-lg font-medium group-hover:text-[#adb4e2]">
                    {item.question}
                  </h3>
                </div>
                <motion.span
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-[#2e48f3] to-[#898e00] text-white font-medium rounded-lg hover:from-[#1428aa] hover:to-[#939900] transition-all duration-300 shadow-lg"
          >
            Contact Support
          </a>
        </motion.div>
