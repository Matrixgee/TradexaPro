...
const Testimonials = () => {
  ...
  return (
    <div className="w-full py-20 bg-gradient-to-b from-[#030514] to-[#080c2f]">
                  ...
                  <div className="relative h-full bg-gray-900 rounded-xl p-8">
                    <div className="flex flex-col items-center">
                      ...
                      <div className="mb-8 relative">
                        <div className="w-20 h-20 rounded-full overflow-hidden ring-4 ring-[#16237a] relative z-10">
                          <img
                            src={testimonial.img}
            ...
            {testimonials.map((_, index) => (
              <motion.button
                ...
                className={`h-2 rounded-full transition-all duration-300 ${
                  currentIndex === index
                    ? "bg-gradient-to-r  from-indigo-600 to-[#3040aa] w-8"
