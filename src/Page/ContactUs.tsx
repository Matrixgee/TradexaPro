...
const ContactUs = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-[#0E0E0E] to-[#1a1a1a] text-white min-h-screen flex flex-col items-center">
      {/* Hero Section */}
      <section className="relative pt-32 pb-20 overflow-hidden w-[90%]">
        <div className="absolute inset-0 z-0 opacity-20">
          <div className="absolute top-1/3 left-1/3 w-96 h-96 bg-[#1427a3] rounded-full filter blur-3xl" />
          <div className="absolute bottom-1/3 right-1/3 w-64 h-64 bg-[#646805] rounded-full filter blur-3xl" />
        </div>
          ...
          <div className="grid grid-cols-2  md:grid-cols-1 lg:grid-cols-2 gap-6">
            {contactInfo.map((item, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-gray-700 hover:border-[#4f67ff] transition-all duration-300"
              >
                <div className="flex items-center mb-4">
                  <div className="w-10 h-10 bg-gradient-to-r from-[#4f67ff] to-[#4a4d03] rounded-full flex items-center justify-center text-white mr-4">
                    {item.icon}
                  </div>
                ...
                <form onSubmit={handleSubmit}>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-[#4f67ff] focus:border-transparent transition-all"
                  ...
                  <div className="mb-6">
                    ...
                    <textarea
                      ...
                      required
                      rows={6}
                      className="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-[#4f67ff] focus:border-transparent transition-all resize-none"
                  ...
                  <button
                    ...
                    className={`w-full px-6 py-4 bg-gradient-to-r from-[#2e48f3] to-[#7d8105] text-white font-medium rounded-lg transition-all duration-300 flex items-center justify-center
                      ${
                        formStatus.isSubmitting
                          ? "opacity-70 cursor-not-allowed"
                          : "hover:bg-gradient-to-r from-[#2e48f3] to-[#7d8105] shadow-lg hover:shadow-[#363c61]"
                      }`}
                  >
                    {formStatus.isSubmitting ? (
                      <>
                ...
                <div className="flex space-x-4 mb-8">
                  {socialLinks.map((social, index) => (
                    <a
                      ...
                      className="w-10 h-10 bg-gray-800 hover:bg-gradient-to-r hover:from-[#2e48f3] to-[#7d8105] rounded-full flex items-center justify-center text-gray-400 hover:text-white transition-all duration-300"
                    >
                      {social.icon}
                    </a>
                  ))}
      ...
      {/* FAQ Quick Links */}
      <section className="py-16 bg-gray-900/50 w-[90%]">
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-3 md:grid-cols-3 gap-6">
            {[
              ...
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                viewport={{ once: true }}
                className="bg-gray-800/30 backdrop-blur-sm p-6 rounded-xl border border-gray-700 hover:border-[#4f67ff] transition-all duration-300"
              >
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="px-8 py-4 bg-[#162691] hover:bg-[#111e74] text-white font-medium rounded-lg transition-all duration-300 flex items-center justify-center"
              >
              ...
              <a
                href="#live-chat"
                className="px-8 py-4 bg-transparent border border-[#162691] hover:border-[#111e74] text-white font-medium rounded-lg transition-all duration-300 flex items-center justify-center"
              >
                <svg
